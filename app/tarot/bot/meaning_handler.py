            ...
            keyboard = [
                ...
                [
                    InlineKeyboardButton(
                        btn_prev_card[0], callback_data=btn_prev_card[1]
                    ),
                    InlineKeyboardButton(
                        btn_next_card[0], callback_data=btn_next_card[1]
                    ),
                ],
                # Ряд 2: Типы трактовок
                [
                    InlineKeyboardButton(
                        f"« {prev_m[1]}",
                        callback_data=f"meaning_{reading_id}_{current_card_idx}_{prev_m[0]}_1",
                    ),
                    InlineKeyboardButton(
                        f"{next_m[1]} »",
                        callback_data=f"meaning_{reading_id}_{current_card_idx}_{next_m[0]}_1",
                    ),
                ],
                # Ряд 3: Пагинация страниц
                [
                    InlineKeyboardButton(
                        btn_prev_page[0], callback_data=btn_prev_page[1]
                    ),
                    InlineKeyboardButton(
                        f"{current_page} / {total_pages}",
                        callback_data="meaning_ignore",
                    ),
                    InlineKeyboardButton(
                        btn_next_page[0], callback_data=btn_next_page[1]
                    ),
                ],
            ]
